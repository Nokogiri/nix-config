  ...
  packages = [
    ...
    }
    {
      ...
      path = fetchurl {
        ...
        sha512 =
          "RLuFstGpHk1wtCRm9Kd+mhLjHZ5+m83+GQ/CsVl06OT7ikCT68yXMEgPmSkgmN5WjzlorsK6H5hIk9Sf6P/7Lg==";
      };
    }
    {
    ...
    }
    {
      ...
      path = fetchurl {
        name = "heroic_wine_downloader___heroic_wine_downloader_1.2.3.tgz";
        url =
          "https://registry.yarnpkg.com/heroic-wine-downloader/-/heroic-wine-downloader-1.2.3.tgz";
        sha512 =
          "njiJ+/hg1PhwGVwTtlm++6qQHVI6rWQtGSi/BA4gLkctt/rb7uYHnX8tkTq6EisXaWVeF5rXNInojH9047PPxw==";
      };
    }
    {
